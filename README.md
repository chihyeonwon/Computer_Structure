...
컴퓨터공학과 컴퓨터구조 정리입니다.
### 2023-06 컴퓨터구조 종강
![image](https://github.com/chihyeonWON/Computer_Structure/assets/58906858/37d34939-ecca-47f7-ae44-4b1ca7635322)
```
영어로 되어있던 수업, 과제, 시험이어서 새로운 경험이었고 영어 공부의 필요성을 느낌
시험칠 때 짜잘한 계산 실수가 많았어서 실수를 좀 더 줄였으면 하는 아쉬움이 남는 과목
```
